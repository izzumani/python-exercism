...
TEMPERATURE =800
NEUTRON_PER_SECOND =500
TEMPERATURE_NEUTRON_PRODUCT=500000
...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    """
    return temperature < TEMPERATURE and  neutrons_emitted > NEUTRON_PER_SECOND and (temperature * neutrons_emitted) <TEMPERATURE_NEUTRON_PRODUCT
